...
export default function SetupPage() {
  ...
  useEffect(() => {
    ...
    if (profile?.readingTime) {
      if (profile?.gateCompleted) {
        router.push('/app');
      } else {
        router.push('/gate');
      }
          ...
          <div className={styles.page}>
            ...
            <div className={styles.content} key={step}>
              ...
              {step === 4 && (
                <>
                  <div style={{ paddingBottom: '20px' }}>
                    <h2 className="t-heading-2" style={{ marginBottom: '16px' }}>What's your vibe?</h2>
                    <div className={styles.cards}>
